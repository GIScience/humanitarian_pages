...
<template>
  <div class="w-full relative bg-white border-b border-slate-200 shadow-sm z-[100] transition-all duration-300 shrink-0">
    ...
    <transition name="collapse">
      <div v-if="isExpanded" class="px-6 py-3 flex flex-col md:flex-row gap-6 items-center justify-center relative">
        <div class="flex flex-col md:flex-row gap-4 w-full items-end pt-1">
          <div class="flex-1 flex flex-col md:flex-row gap-4 items-end justify-start min-w-0">
